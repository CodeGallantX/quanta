    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-indigo-600 mb-2">Quanta</h1>
          <p className="text-gray-600">Your Physics & Chemistry Learning Platform; Yoruba too!</p>
        </div>
        
        <Card>
          <CardHeader>
            <CardTitle>Create Account</CardTitle>
            <CardDescription>Join Quanta and start your learning journey!</CardDescription>
          </CardHeader>
          <CardContent>
